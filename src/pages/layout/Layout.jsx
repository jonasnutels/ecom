...
const moduleItems = [
  {
    ...
    children: [
      ...
      { key: 2, label: <Link to={"/cadastropessoajuridica"}> Pessoa Juridica</Link> },
    ],
  },
  {
    key: "sub2",
    ...
    type: "module",
    children: [
      { key: 5, label:<Link to={"/depositodedinheiro"}> Deposito de Dinheiro</Link>},
      { key: 6, label: <Link to={"/retiradadedinheiro"}> Retirada de Dinheiro</Link> },
    ],
  },
  {
    key: "sub3",
